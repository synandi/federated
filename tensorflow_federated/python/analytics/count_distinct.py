...
def build_client_hyperloglog_computation() -> computation_base.Computation:
  """Builds a tf_computation for computing client hyperloglog sketches.

  Returns:
    A tf_computation for computing client hyperloglog sketches.
  """
...
def build_federated_secure_max_computation() -> computation_base.Computation:
  """Builds a federated_computation for computing max in a secure fashion.

  Returns:
    A federated_computation for computing max of client vectors.
  """
